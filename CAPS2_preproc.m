function PREPROC = CAPS2_preproc(subjects)

% This function automatically preprocess CAPS2 dataset.
%
%
% :Usage:
% ::
%     PREPROC = CAPS2_preproc(subjects)
%
%
% :Input:
% ::
...
tr = 460; % TR 460 msec
ciftify_basedir = fullfile(rscdir, 'matlab_toolboxes/CIFTIFY');
oasis_dir = fullfile(rscdir, 'OASIS_template');
n_thread = 1;
epi_enc_dir = 'ap';
ica_aroma_basedir = fullfile(rscdir, 'matlab_toolboxes/ICA-AROMA');
n_dim = 200;
fwhm = 5;
n_detrend = 1;
bandpass = [0 0.1];
