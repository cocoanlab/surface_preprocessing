...
PREPROC.coregistered_wmseg = fullfile(PREPROC.preproc_anat_dir, 'coregistered_wmseg.nii');
PREPROC.coregistered_csfseg = fullfile(PREPROC.preproc_anat_dir, 'coregistered_csfseg.nii');
system(['export FSLOUTPUTTYPE=NIFTI;' ...
    ...
    'flirt' ...
    ...
    ' -out ' PREPROC.coregistered_wmseg]);
system(['export FSLOUTPUTTYPE=NIFTI;' ...
    ...
    'flirt' ...
    ...
    ' -applyxfm -init ' PREPROC.transform_T1_to_EPI ...
    ' -interp nearestneighbour' ...
    ' -out ' PREPROC.coregistered_csfseg]);
