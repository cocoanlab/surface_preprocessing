...
if regexp(hostname, ['\w*' 'hebenula.local' '\w*'])
    ...
    if add_spm12; addpath(genpath(fullfile(basedir, 'resources/spm12'))); rmpath(genpath(fullfile(basedir, 'resources/spm12/external/fieldtrip/compat'))); end
...
elseif regexp(hostname, ['\w*' 'cnir' '\w*'])
    ...
    if add_spm12; addpath(genpath('/sas1/cocoanlab/Resources/spm12')); rmpath(genpath('/sas1/cocoanlab/Resources/spm12/external/fieldtrip/compat')); end
elseif regexp(hostname, ['\w*' 'JJ-macpro.local' '\w*'])
    ...
    if add_canlab; addpath(genpath(fullfile(rootdir, 'github/canlab'))); rmpath(genpath(fullfile(rootdir, 'github/canlab/MediationToolbox/geom2d'))); rmpath(genpath(fullfile(rootdir, 'github/canlab/CanlabPrivate/preprocess'))); end
    if add_cocoanlab; addpath(genpath(fullfile(rootdir, 'github/cocoanlab'))); end
    if add_spm12; addpath(genpath(fullfile(rootdir, 'resources/spm12'))); rmpath(genpath(fullfile(rootdir, 'resources/spm12/external/fieldtrip/compat'))); end
else
